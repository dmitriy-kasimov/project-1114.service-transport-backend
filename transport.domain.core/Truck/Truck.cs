...
public abstract class Truck<T>(TruckParams truckParams, OverlandParams overlandParams, MechanicalParams<T> mechanicalParams,  ControlledParams controlledParams, TransportParams transportParams) : Overland<T>(overlandParams ,mechanicalParams ,controlledParams, transportParams)
{
